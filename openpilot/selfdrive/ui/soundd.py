...
sound_list: dict[int, tuple[str, int | None, float]] = {
  ...
  AudibleAlert.audioTurn: ("audio_turn.wav", 1, MAX_VOLUME),
  AudibleAlert.audioTurn2: ("audio_turn2.wav", 1, MAX_VOLUME),
